...
#define WIFI_SSID "MTN_4G_5B9B78"
#define WIFI_PASSWORD "*********"

// Insert Firebase project API Key
#define API_KEY "AIzaSyC6hyrmSRyQq6_kTFLwuAlxm9MpGe_0Gd"

// Insert Authorized Username and Corresponding Password
#define USER_EMAIL "afotemid********"
#define USER_PASSWORD "******"

// Insert RTDB URLefine the RTDB URL
#define DATABASE_URL "https://esp-firebase-demo-72ca8-default-rtdb.europe-west1.firebasedatabase.app/"
...
void setup(){
  ...
  config.api_key = "AIzaSyC6hyrmSRyQq6_kTFLwuAlxm9MpGe_0Gd";

  // Assign the user sign in credentials
  auth.user.email = "afotemidayo500@gmail.com";
  auth.user.password = "Oluwabukunmi";

  // Assign the RTDB URL (required)
  config.database_url = "https://esp-firebase-demo-72ca8-default-rtdb.europe-west1.firebasedatabase.app/";
